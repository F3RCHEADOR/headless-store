  ...
  const logOut = () => {
    toast(({ closeToast }) => (
      <div className="text-sm">
        <p className="mb-2">¿Estás seguro de que quieres cerrar sesión?</p>
        <div className="flex gap-2">
          <button
            ...
            className="px-3 py-1 bg-error text-base-content rounded hover:cursor-pointer"
          >
            Sí
          </button>
          <button
            onClick={closeToast}
            className="px-3 py-1 bg-neutral text-white rounded hover:cursor-pointer"
          >
            No
          </button>
        </div>
        ...
        <div className="navbar-end space-x-2">
          <button className="btn btn-ghost btn-circle" onClick={redirectToCart}>
            <div className="indicator">
              ...
              {cartItem.length > 0 && (
                <span className="badge badge-xs badge-primary indicator-item rounded-full">
                  {cartItem.length}
                </span>
              )}
            </div>
